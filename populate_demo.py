...
def populate():
    ...
    # Create initial movies using get_or_create to ensure all 11+ are present
    print("Checking movie catalog...")
    sample_movies = [
    ...
    for m_data in sample_movies:
        Movie.objects.get_or_create(title=m_data["title"], defaults=m_data)
    ...
    theaters_data = [
        ...
        {"name": "IMAX Experience", "location": "City Center"},
    ]
